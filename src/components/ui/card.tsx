...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // overflow-clip, not -hidden: identical corner clipping, but -hidden
        // makes the card a scroll container, which breaks position:sticky for
        // descendants (e.g. the rich-text editor's pinned toolbar).
